...
public class ChatsFragment extends Fragment
{
    ...
    public ChatsFragment(UserInformation userInformation,Bundle bundle) {
        this.userInformation=userInformation;
        this.bundle=bundle;
    }

    public static ChatsFragment newInstance(UserInformation userInformation,Bundle bundle) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        DialogAdapter.ItemClickListener itemClickListener=new DialogAdapter.ItemClickListener() {
            ...
            public void onItemClick(String userName) {
                ...
                chatIntent.putExtra("othUser", userName);
