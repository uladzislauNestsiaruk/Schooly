...
public class WardrobeShoes extends Fragment {
    ...
    public WardrobeShoes(String type,Fragment fragment,UserInformation userInformation,Bundle bundle,String fragmentString) {
        this.type = type;
    ...
    public static WardrobeShoes newInstance(String type,Fragment fragment,UserInformation userInformation,Bundle bundle,String fragmentString) {
        return new WardrobeShoes(type,fragment,userInformation,bundle,fragmentString);
    }
            ...
            RecentMethods.getClothesInWardrobe(nick, firebaseModel, new Callbacks.GetClothes() {
                ...
                public void getClothes(ArrayList<Clothes> allClothes) {
                    ...
                    if (sortShoesArrayListWardrobe.size()==0){
                        ...
                        WardrodeClothesAdapter newClothesAdapter = new WardrodeClothesAdapter(sortShoesArrayListWardrobe, itemClickListener,userInformation,fragmentString);
