...
public class LipsFragment extends Fragment {
    ...
    public static LipsFragment newInstance() {
    ...
    public void onViewCreated(@Nullable View view,@NonNull Bundle savedInstanceState){
        ...
        CharacterAdapter characterAdapter=new CharacterAdapter(bodyPartsArrayList,itemClickListener,activeFaceParts,"lips");
